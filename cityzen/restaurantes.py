...
class restaurantesguiaocio(CrawlSpider):
    name = 'restaurantesguiaocio'
    custom_settings = {
    ...
    start_urls = ["https://www.guiadelocio.com/madrid/restaurantes"]
    ...
    def parse_hotel(self, response):
        ...
        item = ItemLoader(Restaurante(), sel)
